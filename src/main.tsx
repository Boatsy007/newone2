...
createRoot(document.getElementById('root')!).render(
  <StrictMode><BrowserRouter><ScrollToTop/><ImportHandoffInjector/><AdminWorkflowMobileFix/><AdminClubProfileFallback/><HomePlayerProfileLinks/><HomeRecordsPortal/><HomePlayerRecordsPortal/><AutoShareButtons/><ProfileShareButton/><Routes>
