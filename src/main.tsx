...
createRoot(document.getElementById('root')!).render(
  <StrictMode><BrowserRouter><ScrollToTop/><ImportHandoffInjector/><AdminWorkflowMobileFix/><AdminClubProfileFallback/><GoalKickerMistakeManager/><GoalKickerReviewEnhancer/><GoalKickerAchievementManager/><NewsroomManager/><GoalKickerPublicIntegration/><GoalKickerAchievementsPortal/><RankingHealthPortal/><HomePlayerProfileLinks/><HomeRecordsPortal/><HomePlayerRecordsPortal/><AutoShareButtons/><ProfileShareButton/><Routes>
