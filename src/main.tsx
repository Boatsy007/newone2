...
createRoot(document.getElementById('root')!).render(
  <StrictMode><BrowserRouter><ScrollToTop/><ImportHandoffInjector/><UniversalBatchImportEnhancer/><AdminWorkflowMobileFix/><AdminClubProfileFallback/><AdminHealthLink/><GoalKickerMistakeManager/><GoalKickerReviewEnhancer/><GoalKickerAchievementManager/><NewsroomManager/><GoalKickerPublicIntegration/><GoalKickerAchievementsPortal/><HighlightPublicIntegration/><RankingHealthPortal/><UnifiedSearchExtras/><HomePlayerProfileLinks/><HomeRecordsPortal/><HomePlayerRecordsPortal/><HomeFeatureCopy/><NewsChannelFilter/><NewsEditorialLayout/><AutoShareButtons/><ProfileShareButton/><ErrorBoundary><Routes>
