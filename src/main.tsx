...
createRoot(document.getElementById('root')!).render(
  <StrictMode><BrowserRouter><ScrollToTop/><ImportHandoffInjector/><AdminWorkflowMobileFix/><AdminClubProfileFallback/><GoalKickerMistakeManager/><GoalKickerReviewEnhancer/><GoalKickerAchievementManager/><GoalKickerPublicIntegration/><GoalKickerAchievementsPortal/><HomePlayerProfileLinks/><HomeRecordsPortal/><HomePlayerRecordsPortal/><AutoShareButtons/><ProfileShareButton/><Routes>
