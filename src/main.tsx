...
import AdminPhaseOnePolish from './components/admin/AdminPhaseOnePolish.tsx'
...
createRoot(document.getElementById('root')!).render(
  <StrictMode><BrowserRouter><ScrollToTop/><ImportHandoffInjector/><AdminPhaseOnePolish/><HomePlayerProfileLinks/><AutoShareButtons/><ProfileShareButton/><Routes>
