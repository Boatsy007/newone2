...
createRoot(document.getElementById('root')!).render(
  <StrictMode><BrowserRouter><ScrollToTop/><ImportHandoffInjector/><UniversalBatchImportEnhancer/><UniversalBulkImportActions/><AdminWorkflowMobileFix/><AdminClubProfileFallback/><AdminHealthLink/><AdminLogoManager/><GoalKickerMistakeManager/><GoalKickerReviewEnhancer/><GoalKickerAchievementManager/><NewsroomManager/><GoalKickerPublicIntegration/><GoalKickerAchievementsPortal/><HighlightPublicIntegration/><RankingHealthPortal/><UnifiedSearchExtras/><HomePlayerProfileLinks/><HomeRecordsPortal/><HomePlayerRecordsPortal/><HomeFeatureCopy/><HomeDesktopPolish/><ClubFixtureBridge/><DirectoryPublicFix/><LeaguesPublicFinder/><NewsChannelFilter/><NewsEditorialLayout/><AutoShareButtons/><ProfileShareButton/><ErrorBoundary><Routes>
