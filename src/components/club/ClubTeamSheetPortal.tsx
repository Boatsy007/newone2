...
export default function ClubTeamSheetPortal(){
 ...
 return createPortal(<section className={`club-team-sheet${active?' is-active':''}`} aria-hidden={!active}>
