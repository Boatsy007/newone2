...
.md:fullscreen .md-ground,.md:-webkit-full-screen .md-ground,body.pf-match-day-focus .md-ground{flex:none!important;width:88vh!important;height:88vw!important;min-height:0!important;max-width:none!important;aspect-ratio:auto!important;border-width:3px!important;transform:rotate(90deg)!important;transform-origin:center!important}
...
@media(max-height:620px){.md:fullscreen .md-ground-wrap,.md:-webkit-full-screen .md-ground-wrap,body.pf-match-day-focus .md-ground-wrap{transform:translateY(-3vh)!important}.md:fullscreen .md-ground,.md:-webkit-full-screen .md-ground,body.pf-match-day-focus .md-ground{width:86vh!important;height:86vw!important}.md:fullscreen .md-player.on-field,.md:-webkit-full-screen .md-player.on-field,body.pf-match-day-focus .md-player.on-field{width:15%!important;max-width:94px!important}.md:fullscreen .md-toolbar,.md:-webkit-full-screen .md-toolbar,body.pf-match-day-focus .md-toolbar{transform:translateX(-50%) scale(.9)!important;transform-origin:top center!important}}
`
