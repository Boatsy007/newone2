...
body:has(.club-hq-bottom) .cp-dashboard,body:has(.club-hq-bottom) .club-portal-page,body:has(.club-hq-bottom) .club-portal-profile,body:has(.club-hq-bottom) .club-portal-page-wrap,body:has(.club-hq-bottom) .cpp{margin-left:0!important;width:auto!important;max-width:none!important;box-sizing:border-box!important;padding-bottom:112px!important}body:has(.club-hq-bottom) #root>nav,body:has(.club-hq-bottom) #root>footer{margin-left:0!important}body:has(.club-hq-bottom) .coach-workspace-layer{left:0!important;padding-bottom:112px!important}body:has(.club-hq-bottom) .cmp-shell{padding-bottom:132px!important}
@media(min-width:761px){.club-hq-bottom{left:50%;right:auto;bottom:18px;width:min(920px,calc(100% - 36px));transform:translateX(-50%);border:1px solid #dfe4e8;border-radius:22px;padding:8px;box-shadow:0 14px 38px rgba(15,23,42,.14)}.pf-menu-open .club-hq-bottom{transform:translate(-50%,calc(100% + 40px))}.club-hq-bottom a{min-height:60px;font-size:10px}body:has(.club-hq-bottom) .cp-dashboard{padding-left:clamp(18px,4vw,54px)!important;padding-right:clamp(18px,4vw,54px)!important}body:has(.club-hq-bottom) .cp-dashboard>*{max-width:1380px!important}body:has(.club-hq-bottom) .cpp{padding-left:clamp(18px,4vw,54px)!important;padding-right:clamp(18px,4vw,54px)!important}body:has(.club-hq-bottom) .cpp>*{max-width:1380px!important}body:has(.club-hq-bottom) .cmp-shell{padding-left:clamp(24px,3vw,46px)!important;padding-right:clamp(24px,3vw,46px)!important}body:has(.club-hq-bottom) .cmp-content{max-width:1320px!important}}
@media(max-width:1000px) and (min-width:761px){body:has(.club-hq-bottom) .cp-layout{grid-template-columns:minmax(0,1fr) 300px!important}body:has(.club-hq-bottom) .cp-tools{grid-template-columns:1fr!important}body:has(.club-hq-bottom) .cmp-sidebar{width:230px!important}body:has(.club-hq-bottom) .cmp-shell{margin-left:230px!important;padding-left:22px!important;padding-right:22px!important}}
@media(max-width:760px){.club-hq-bottom>div{min-width:0}.club-hq-bottom a{font-size:8px}.club-hq-bottom a svg{width:20px;height:20px}.club-hq-bottom a span{white-space:nowrap}body:has(.club-hq-bottom) .coach-workspace-layer{padding-bottom:100px!important}body:has(.club-hq-bottom) .cmp-sidebar{display:none!important}body:has(.club-hq-bottom) .cmp-shell{margin-left:0!important;padding:14px 9px 112px!important}body:has(.club-hq-bottom) .cmp-mobile-nav{position:sticky!important;top:0!important;bottom:auto!important;z-index:6!important;display:grid!important;grid-template-columns:repeat(5,minmax(76px,1fr))!important;overflow-x:auto!important;margin:-14px -9px 16px!important;padding:8px 9px!important;border-top:0!important;border-bottom:1px solid #dfe4e8!important;background:rgba(250,251,252,.98)!important;box-shadow:0 7px 18px rgba(15,23,42,.05)!important;backdrop-filter:blur(18px)}body:has(.club-hq-bottom) .cmp-mobile-nav button{min-height:45px!important;flex-direction:row!important;gap:6px!important;font-size:9px!important}body:has(.club-hq-bottom) .cmp-more-backdrop{z-index:100350!important;padding-bottom:82px!important}body:has(.club-hq-bottom) .cp-layout{grid-template-columns:1fr!important}body:has(.club-hq-bottom) .cp-summary{grid-template-columns:1fr 1fr!important}}
@media(max-width:520px){body:has(.club-hq-bottom) .cp-summary{grid-template-columns:1fr!important}body:has(.club-hq-bottom) .cp-dashboard{padding-left:9px!important;padding-right:9px!important}body:has(.club-hq-bottom) .cpp{padding-left:8px!important;padding-right:8px!important}}
