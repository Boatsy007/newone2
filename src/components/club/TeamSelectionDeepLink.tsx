...
async function shareGraphic(graphic:GeneratedGraphic){
 ...
 if(!navigator.share||shareNavigator.canShare&&!shareNavigator.canShare({files:[file]}))throw new Error('Photo saving is not supported in this browser. Use Download file instead.')
