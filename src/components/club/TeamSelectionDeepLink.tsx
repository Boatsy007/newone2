...
import ClubMediaPortalOverlay from './ClubMediaPortalOverlay'

export default function TeamSelectionDeepLink(){
 const{pathname,search}=useLocation()
 const navigate=useNavigate()
 const mediaMatch=pathname.match(/^\/club-portal\/([^/]+)\/media\/?$/)
 ...
 return mediaMatch?createPortal(<ClubMediaPortalOverlay clubId={mediaMatch[1]}/>,document.body):null
}
