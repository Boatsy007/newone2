...
export default function Nav() {
  ...
  return <>
    ...
    <style>{`
      ...
      @media(max-width:1050px){.pf-desktop-links,.pf-primary-action{display:none}.pf-nav-inner{height:72px;padding:0 18px}.pf-brand img{width:166px}.pf-nav-actions{margin-left:auto}.pf-menu-button{display:block}.pf-mobile-menu{inset:72px 0 0}}
