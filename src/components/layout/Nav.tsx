...
export default function Nav() {
  ...
  return <>
    ...
    <style>{`
      ...
      .pf-mobile-menu{position:fixed;z-index:70;inset:76px 0 0;background:#050505;color:#fff;padding:24px 24px 40px;overflow:auto}.pf-mobile-menu nav{display:grid}.pf-mobile-menu nav a{display:flex;align-items:center;justify-content:space-between;color:#fff;text-decoration:none;border-bottom:1px solid rgba(255,255,255,.16);padding:18px 0}.pf-mobile-menu nav span{font-family:'Bebas Neue',Impact,sans-serif;font-size:clamp(2.4rem,12vw,4.3rem);line-height:.9;text-transform:uppercase}.pf-mobile-menu nav small{color:#2daaf5;font-weight:950}.pf-mobile-search,.pf-mobile-cta,.pf-mobile-share .pf-share-action{display:flex;align-items:center;justify-content:center;gap:10px;width:100%;box-sizing:border-box;margin-top:22px;text-align:center;text-decoration:none;text-transform:uppercase;font-family:'Barlow Condensed',Arial,sans-serif;font-weight:900;padding:17px;border-radius:999px}.pf-mobile-search{border:1px solid rgba(255,255,255,.24);background:#fff;color:#050505}.pf-mobile-share .pf-share-action{border:1px solid rgba(255,255,255,.24);color:#fff;background:transparent}.pf-mobile-cta{margin-top:12px;background:#2daaf5;color:#050505}
      ...
      @media(max-width:1220px){.pf-desktop-links,.pf-primary-action,.pf-nav-actions>.pf-share-action{display:none}.pf-nav-inner{height:72px;padding:0 18px}.pf-brand img{width:166px}.pf-nav-actions{margin-left:auto}.pf-menu-button{display:block}.pf-mobile-menu{inset:72px 0 0}}
