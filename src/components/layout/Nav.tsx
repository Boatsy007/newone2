  ...
  return <>
    <header className="pf-nav">
      <div className="pf-nav-inner">
        ...
        <div className="pf-nav-actions">
          ...
          <Link to="/admin" className="pf-primary-action">Admin</Link>
    ...
    {open && <div className="pf-mobile-menu">
      ...
      <div className="pf-mobile-menu-actions">
        ...
        <Link to="/admin" className="pf-mobile-cta">Admin</Link>
      </div>
    </div>}
    ...
    <style>{`
      ...
      .pf-profile-follow{position:fixed;right:18px;bottom:18px;z-index:64}
