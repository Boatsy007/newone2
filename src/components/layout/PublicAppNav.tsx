...
import PlayFootyNavigationLoading from '../PlayFootyNavigationLoading'
...
export default function PublicAppNav(){
 ...
 return <><NativeAppBootstrap/><PlayFootyNavigationLoading/><PublicAnalyticsTracker/><MatchCentreLiveBanner/>{createPortal(<>
