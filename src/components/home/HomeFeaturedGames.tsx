...
function Team({team}:{team:TeamMetric}){return <div><span className="pf-featured-game-logo"><TeamLogo name={team.clubName} src={team.logoUrl??undefined} size={112}/></span><strong>{team.clubName}</strong></div>}
