...
const styles = `
.pf-feature-grid>.pf-featured-highlights{grid-column:1/-1;order:-1;width:100%;display:block;background:#fff;border-top:12px solid #eef3f7;padding:38px 0 48px;box-sizing:border-box;font-family:Barlow,Inter,Arial,sans-serif}
