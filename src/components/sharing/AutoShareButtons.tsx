    ...
    const enhance = () => {
      ...
      timer = window.setTimeout(() => {
        document.querySelectorAll<HTMLAnchorElement>('a[href]').forEach(anchor => {
          ...
          if (anchor.closest('.pf-nav,.pf-mobile-menu,.pf-share-action,.pf-auto-share,.gk-no-auto-share,.pf-featured-highlights') || anchor.classList.contains('pf-number-one')) return
