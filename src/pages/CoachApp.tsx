...
import CoachAppWhiteboard from './CoachAppWhiteboardStage2'
...
export default function CoachApp(){
 ...
 if(loading)return <CoachAppLoading message="Opening your team…"/>
  ...
  return <main className="coach-app-root"><style>{styles}</style>
    ...
    {screen==='CLUB_DASHBOARD'&&<CoachAppClubDashboard clubName={context.club.name} logoUrl={context.club.logoUrl} allowedAreas={context.access?.allowedAreas} onOpen={(area:ClubAppArea)=>{if(area==='coaching')setScreen('DASHBOARD');if(area==='permissions')setScreen('PERMISSIONS')}}/>}
