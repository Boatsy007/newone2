...
export default function ResetPassword() {
  ...
  async function submit(event: React.FormEvent) {
    ...
    setError('')
    setMessage('')
    if (!token) return setError('This password-reset link is invalid or has expired. Request a new link from Club Login or League Login.')
    ...
    try {
      ...
      setPassword('')
      setConfirm('')
      setMessage('Your password has been updated. You can now sign in to the Club Portal or League Portal.')
    } catch (reason) {
