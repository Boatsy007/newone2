      ...
      {!loading && data && <>
          ...
          <div className="player-shell player-hero-inner">
            <div className="player-identity">
              <div>
                ...
                <p className="player-associations">
                  {data.clubId ? <Link to={`/team/${data.clubId}`}>{data.clubName}</Link> : <span>{data.clubName}</span>}
        ...
        <section className="player-shell player-content">
          <div className="player-main">
            {details?.photoUrl && <section className="player-profile-photo">
              <img src={details.photoUrl} alt={`${data.playerName} player profile`} />
            </section>}
