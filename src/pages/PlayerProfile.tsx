...
export default function PlayerProfile() {
  ...
  useSeo({
    ...
    description: data ? `${data.playerName} plays for ${data.clubName} in ${data.leagueName}. View goals, matches, goal-kicking rank and season history.` : 'Community football player profile and goal-kicking statistics.',
    ...
    <main>
      ...
      {!loading && data && <>
        ...
        <section className="player-shell player-content">
          <div className="player-main">
            <section className="player-card stats-card">
              ...
              <div className="stat-grid">
                <Stat label="Goals" value={String(data.goals)} />
                ...
                <Stat label="Adjusted goals" value={data.adjustedGoals.toFixed(1)} />
              </div>
            </section>
          ...
          <aside className="player-card player-sidebar">
