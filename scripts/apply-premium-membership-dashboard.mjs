...
const marker="function Dashboard({overview,members,products,onOpen}:{overview:Overview|null;members:Member[];products:Product[];onOpen:(view:ViewMode)=>void}){"
const start=src.indexOf(marker)
if(start<0)throw new Error('Membership Dashboard signature not found')
