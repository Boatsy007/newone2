(() => {
  ...
  function style() {
    ...
    node.textContent = `
      ...
      #pf-kpi-tab.pf-kpi-tab{position:absolute!important;z-index:125!important;top:8px!important;left:calc(50% - 2px)!important;right:auto!important;bottom:auto!important;inset:auto auto auto calc(50% - 2px)!important;display:flex!important;align-items:center!important;justify-content:center!important;width:92px!important;min-width:92px!important;max-width:92px!important;height:42px!important;min-height:42px!important;max-height:42px!important;margin:0!important;padding:0 10px!important;border:0!important;border-radius:9px!important;background:#d5a112!important;color:#101820!important;font-family:inherit!important;font-size:10px!important;font-weight:950!important;line-height:1!important;letter-spacing:.02em!important;text-align:center!important;text-transform:uppercase!important;white-space:nowrap!important;writing-mode:horizontal-tb!important;transform:none!important;box-shadow:0 5px 16px rgba(0,0,0,.3)!important;touch-action:manipulation!important;appearance:none!important;-webkit-appearance:none!important}.pf-kpi-drawer{position:absolute;z-index:124;inset:0 auto 0 0;width:50%;box-sizing:border-box;padding:18px;background:#07111c;color:#fff;border-right:1px solid #263946;transform:translateX(-102%);transition:transform .2s ease;overflow:auto}.pf-kpi-drawer.open{transform:translateX(0)}.pf-kpi-drawer-head{display:flex;justify-content:space-between;align-items:center;margin-bottom:12px}.pf-kpi-drawer-head h2{margin:0}.pf-kpi-close{width:40px;height:40px;border:1px solid #334754;border-radius:9px;background:#13232e;color:#fff;font-size:22px}.pf-kpi-drawer .pf-kpi-row{border-color:#263946;background:#0e1b25}.pf-kpi-drawer .pf-kpi-label small{color:#8798a4}.pf-kpi-drawer .pf-kpi-value{border-color:#3a4d59;background:#07111c;color:#fff}
      @media(max-height:620px){#pf-kpi-tab.pf-kpi-tab{top:6px!important;height:36px!important;min-height:36px!important;max-height:36px!important}.pf-kpi-drawer{padding:11px 14px}.pf-kpi-drawer .pf-kpi-row{padding:5px 8px;grid-template-columns:minmax(0,1fr) 40px 50px 40px}.pf-kpi-drawer .pf-kpi-step,.pf-kpi-drawer .pf-kpi-value{height:36px}}
    `
