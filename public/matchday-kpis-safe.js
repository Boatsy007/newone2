(() => {
  ...
  function style() {
    ...
    node.textContent = `
      ...
      .pf-kpi-drawer{position:absolute;z-index:124;inset:0 auto 0 0;width:50%;box-sizing:border-box;padding:18px;background:#07111c;color:#fff;border-right:1px solid #263946;transform:translateX(-102%);transition:transform .2s ease;overflow:auto}.pf-kpi-drawer.open{transform:translateX(0)}.pf-kpi-drawer-head{display:flex;justify-content:space-between;align-items:center;margin-bottom:12px}.pf-kpi-drawer-head h2{margin:0}.pf-kpi-close{width:40px;height:40px;border:1px solid #334754;border-radius:9px;background:#13232e;color:#fff;font-size:22px}.pf-kpi-drawer .pf-kpi-row{border-color:#263946;background:#0e1b25}.pf-kpi-drawer .pf-kpi-label small{color:#8798a4}.pf-kpi-drawer .pf-kpi-value{border-color:#3a4d59;background:#07111c;color:#fff}
      @media(max-height:620px){.pf-kpi-drawer{padding:11px 14px}.pf-kpi-drawer .pf-kpi-row{padding:5px 8px;grid-template-columns:minmax(0,1fr) 40px 50px 40px}.pf-kpi-drawer .pf-kpi-step,.pf-kpi-drawer .pf-kpi-value{height:36px}}
    `
