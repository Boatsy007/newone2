...
export function AflOval({dark=false,markings=true,classic=false,horizontal=false}:Props){
 const edge=dark?'#2CF18F':classic?'#375D2C':'#557A3D'
 const line=dark?'rgba(255,255,255,.55)':'rgba(255,255,255,.64)'
