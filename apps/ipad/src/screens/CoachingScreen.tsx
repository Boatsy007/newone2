...
type Props = { club: ClubAccount; session: AuthSession; onOpenTrainingPlan: (sessionNumber: 1 | 2) => void; onOpenTrainingReport: (sessionNumber: 1 | 2) => void; onOpenAvailability: () => void; onOpenTeamSelection: () => void; onOpenGamePlan: () => void; onOpenMatchDay: () => void }
...
export function CoachingScreen({ club, session, onOpenTrainingPlan, onOpenTrainingReport, onOpenAvailability, onOpenTeamSelection, onOpenGamePlan, onOpenMatchDay }: Props) {
