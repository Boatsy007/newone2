...
type Props = { club: ClubAccount; session: AuthSession; onOpenTrainingPlan: (sessionNumber: 1 | 2) => void }
...
export function CoachingScreen({ club, session, onOpenTrainingPlan }: Props) {
